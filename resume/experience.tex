  ...
  \cventry
    ...
    {Jul. 2024 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Implemented automation for barcode generation to streamline container management for both B2B and B2C operations, driving efficiency and scalability in key business processes.}
      \end{cvitems}
    }
