...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Demonstrated discipline, leadership, and a strong sense of duty during the successful completion of mandatory military service.}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Refactored 85\% of warehouse management flow, maintaining 70\% testing coverage which and reducing production error rates.}
